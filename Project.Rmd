...
```{r}
#Compute the test of 𝛽1 (or other test from above) or find a CI for 𝛽1. Remember that if you have transformed data, you should be careful about your interpretations. Your test or CI should include an interpretation in the words of your variable

#confidence interval for education num
l.model <- lm(education_num ~ 1, income_data)
...
p <- ggplot(income_data, aes(x = education_num, y =  prop_over_50k)) + geom_point() + labs(x = 'Education Level', y = 'Income')
...
l.model2 <- lm(income_trans ~ education_num, income_data)

rsquare(l.model2, income_data)
